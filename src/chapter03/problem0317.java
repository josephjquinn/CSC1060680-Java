...
public class problem0317
{
    public static void main(String[] args)
    {
        ...
        {
            case 1:
                System.out.println("The computer is " + game_computer + " and you are " + game_user + ". You won."); break;
            case 2:
                System.out.println("The computer is " + game_computer + " and you are " + game_user + ". It is a draw."); break;
            case 3:
                System.out.println("The computer is " + game_computer + " and you are " + game_user + ". You lost."); break;
        }
